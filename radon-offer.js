(function () {
  ...
  style.textContent = `
    ...
    .radon-offer-form{display:grid;grid-template-columns:1fr auto;gap:10px;margin:0 auto;max-width:460px;text-align:left}
    .radon-offer-form input[type=email]{min-width:0;border:1px solid #514c42;border-radius:12px;background:#1a1a1a;color:#fff;padding:15px 16px;font:inherit;outline:none}
    .radon-offer-form input[type=email]:focus{border-color:#d8bd68;box-shadow:0 0 0 3px rgba(216,189,104,.15)}
    ...
    .radon-offer-code{display:inline-block;margin:12px 0 5px;border:1px dashed #d8bd68;border-radius:10px;padding:10px 15px;color:#d8bd68;font-size:21px;font-weight:800;letter-spacing:.06em}
  ...
  backdrop.innerHTML = `
    <section class="radon-offer">
      ...
      <div class="radon-offer-inner">
        ...
        <p class="radon-offer-fine">Coupon code RADON50OFF. Valid when radon testing is booked with a complete home inspection. One coupon per property. Cannot be combined with other offers.</p>
      </div>
    </section>`;
  ...
  form.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      backdrop.querySelector(".radon-offer-inner").innerHTML = `
        ...
        <p class="radon-offer-copy">Use code</p><div class="radon-offer-code">RADON50OFF</div>
        <p class="radon-offer-fine">Mention the code when scheduling your complete home inspection and radon test.</p>`;
    } catch {
