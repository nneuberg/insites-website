...
export default async (request) => {
  ...
  const response = await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({
      ...
      subject: `${firstName}, your $50 radon testing coupon from InSites`,
      html,
